function trabalhoTodo() {
  var botaoAdicionar = document.querySelector("#adicionar-todo-trabalho");
  botaoAdicionar.addEventListener("click", function (event) {
    event.preventDefault();

    //achando elemento
    var form = document.querySelector("#form-adiciona-trabalho");
    ...
    form.reset();
    var ul = document.querySelector("#mensagens-erro-trabalho");
    ul.innerHTML = "";
  });
  ...
  function montaTr(todo) {
    ...
    doTr.classList.add("do-trabalho");
