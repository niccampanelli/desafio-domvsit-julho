function academiaTodo() {
  var botaoAdicionar = document.querySelector("#adicionar-todo-academia");
  botaoAdicionar.addEventListener("click", function (event) {
    event.preventDefault();

    //achando elemento
    var form = document.querySelector("#form-adiciona-academia");
    ...
    form.reset();
    var ul = document.querySelector("#mensagens-erro-academia");
    ul.innerHTML = "";
  });
  ...
  function montaTr(todo) {
    ...
    doTr.classList.add("do-academia");
