function especiaisTodo() {
  var botaoAdicionar = document.querySelector("#adicionar-todo-especiais");
  botaoAdicionar.addEventListener("click", function (event) {
    event.preventDefault();

    //achando elemento
    var form = document.querySelector("#form-adiciona-especiais");
    ...
    form.reset();
    var ul = document.querySelector("#mensagens-erro-especiais");
    ul.innerHTML = "";
  });
  ...
  function montaTr(todo) {
    ...
    doTr.classList.add("do-especiais");
