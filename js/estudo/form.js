function estudoTodo() {
  var botaoAdicionar = document.querySelector("#adicionar-todo-estudo");
  botaoAdicionar.addEventListener("click", function (event) {
    event.preventDefault();

    //achando elemento
    var form = document.querySelector("#form-adiciona-estudo");
    ...
    form.reset();
    var ul = document.querySelector("#mensagens-erro-estudo");
    ul.innerHTML = "";
  });
